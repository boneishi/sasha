...
export const ManufacturingIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M10.343 3.94c.09-.542.56-1.025 1.11-1.115l.612-.162a2.25 2.25 0 0 1 1.865 1.865l.162.612c.095.55.572 1.025 1.11 1.115l.612.162a2.25 2.25 0 0 1 1.865 1.865l.162.612c.095.55.572 1.025 1.11 1.115l.613.162a2.25 2.25 0 0 1 0 3.482l-.613.162c-.54.09-.995.55-1.11 1.115l-.162.612a2.25 2.25 0 0 1-1.865 1.865l-.612.162c-.55.095-1.025.572-1.11 1.115l-.162.612a2.25 2.25 0 0 1-3.482 0l-.162-.612c-.09-.542-.56-1.025-1.11-1.115l-.612-.162a2.25 2.25 0 0 1-1.865-1.865l-.162-.612c-.095-.55-.572-1.025-1.11-1.115l-.613-.162a2.25 2.25 0 0 1 0-3.482l.613-.162c.54-.09.995.55 1.11-1.115l.162-.612a2.25 2.25 0 0 1 1.865-1.865l.612-.162Z" />
...
export const CrmIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 0 0 3.741-.479 3 3 0 0 0-4.682-2.72m-7.512 2.72a9.094 9.094 0 0 1-3.741-.479 3 3 0 0 1 4.682-2.72M13.5 3.75a9.094 9.094 0 0 1 9 0M4.5 3.75a9.094 9.094 0 0 0 9 0m-9 0a3 3 0 0 0 0 5.636m9-5.636a3 3 0 0 1 0 5.636m0 0a3 3 0 0 1-9 0" />
  </svg>
);

export const ProductionIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17 17.25 21A2.652 2.652 0 0 0 21 17.25l-5.877-5.877M11.42 15.17l2.495-2.495a1.5 1.5 0 0 1 2.122 0l2.121 2.121a1.5 1.5 0 0 1 0 2.122l-2.495 2.495M3 9l9-9 4.5 4.5-3 3-6-6-4.5 4.5 3 3" />
  </svg>
);

export const InstallationIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const BuildingStorefrontIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M13.5 21v-7.5A2.25 2.25 0 0 0 11.25 11.25H4.5A2.25 2.25 0 0 0 2.25 13.5V21M3 3h12M12 3v.75M12 16.5v.75m-6-3v.75m.75-3.75h3.75m-3.75 0V15m3.75 0V15m0-3.75H9M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 21H13.5m5.25 0H18v-7.5c0-1.242-1.008-2.25-2.25-2.25H13.5" />
  </svg>
);
...
export const ChatBubbleLeftRightIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M8.625 12a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H8.25m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0H12m4.125 0a.375.375 0 11-.75 0 .375.375 0 01.75 0zm0 0h-.375M21 12c0 4.556-4.03 8.25-9 8.25a9.764 9.764 0 01-2.555-.337A5.972 5.972 0 015.41 20.97a5.969 5.969 0 01-.474-.065 4.48 4.48 0 00.978-2.025c.09-.455.09-.934.09-1.425v-2.287a6.75 6.75 0 016.75-6.75h2.25l.254-.017A2.373 2.373 0 0021 9.75v2.25zM12.75 6a3.75 3.75 0 00-3.75-3.75S6 3 6 6c0 1.865 1.343 3.422 3.146 3.684A6.75 6.75 0 0112.75 6z" />
    </svg>
);
...
export const SaveIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 3.75H6.168a2.25 2.25 0 0 0-2.18 2.583l.732 7.321a2.25 2.25 0 0 0 2.179 2.179h9.581a2.25 2.25 0 0 0 2.179-2.179l.732-7.321a2.25 2.25 0 0 0-2.18-2.583H15M9 3.75a3 3 0 0 1 6 0M9 3.75a3 3 0 0 0 6 0" />
    </svg>
);
...
export const SquaresPlusIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
...
export const Cog6ToothIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.025 1.11-1.115l.612-.162a2.25 2.25 0 0 1 1.865 1.865l.162.612c.095.55.572 1.025 1.11 1.115l.612.162a2.25 2.25 0 0 1 1.865 1.865l.162.612c.095.55.572 1.025 1.11 1.115l.612.162a2.25 2.25 0 0 1 0 3.482l-.612.162c-.55.09-.995.55-1.11 1.115l-.162.612a2.25 2.25 0 0 1-1.865 1.865l-.612.162c-.55.095-1.025.572-1.11 1.115l-.162.612a2.25 2.25 0 0 1-3.482 0l-.162-.612c-.09-.542-.56-1.025-1.11-1.115l-.612-.162a2.25 2.25 0 0 1-1.865-1.865l-.162-.612c-.095-.55-.572-1.025-1.11-1.115l-.612-.162a2.25 2.25 0 0 1 0-3.482l.612-.162c.55-.09.995.55 1.11-1.115l.162-.612a2.25 2.25 0 0 1 1.865-1.865l.612-.162Z" />
...
export const SashWindowIcon = (props: IconProps) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <line x1="12" y1="3" x2="12" y2="12" stroke="currentColor" strokeWidth="1" />
        <line x1="12" y1="12" x2="12" y2="21" stroke="currentColor" strokeWidth="1" />
        <line x1="4" y1="7.5" x2="20" y2="7.5" stroke="currentColor" strokeWidth="1" />
        <line x1="4" y1="16.5" x2="20" y2="16.5" stroke="currentColor" strokeWidth="1" />
    </svg>
);

export const CasementWindowIcon = (props: IconProps) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        <rect x="4" y="3" width="16" height="18" rx="1" stroke="currentColor" strokeWidth="1.5" />
        <line x1="12" y1="3" x2="12" y2="21" stroke="currentColor" strokeWidth="1.5" />
        <path d="M12 18L5 15" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeDasharray="2 2" />
        <path d="M12 18L19 15" stroke="currentColor" strokeWidth="1" strokeLinecap="round" strokeDasharray="2 2" />
    </svg>
);
...
export const DoorIcon = (props: IconProps) => (
    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" {...props}>
        ...
        <rect x="8" y="6" width="8" height="5" rx="0.5" stroke="currentColor" strokeWidth="1" />
        <circle cx="16" cy="12" r="1" fill="currentColor" stroke="currentColor" strokeWidth="0.5" />
    </svg>
);
...
export const MoonIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M21.752 15.002A9.72 9.72 0 0 1 18 15.75c-5.385 0-9.75-4.365-9.75-9.75 0-1.33.266-2.597.748-3.752A9.753 9.753 0 0 0 3 11.25c0 5.385 4.365 9.75 9.75 9.75 2.833 0 5.424-.962 7.5-2.548Z" />
  </svg>
);
...
export const FunnelIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3c2.755 0 5.455.232 8.083.678a1.5 1.5 0 0 1 1.242 1.242C21.768 7.545 22 10.245 22 13.5c0 3.255-.232 5.955-.678 8.583a1.5 1.5 0 0 1-1.242 1.242C17.455 23.768 14.755 24 12 24c-2.755 0-5.455-.232-8.083-.678a1.5 1.5 0 0 1-1.242-1.242C2.232 19.455 2 16.755 2 13.5c0-3.255.232-5.955.678-8.583a1.5 1.5 0 0 1 1.242-1.242C4.545 3.232 7.245 3 12 3Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M6 8.25h12M8.25 12h7.5M10.5 15.75h3" />
  </svg>
);

export const TrophyIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.5 18.75h-9V9.75a4.5 4.5 0 0 1 9 0v9ZM18 9.75a2.25 2.25 0 0 0-2.25-2.25H8.25A2.25 2.25 0 0 0 6 9.75m12 9h2.25m-16.5 0H3.75m9-13.5V3.75M9 6.75h6" />
  </svg>
);

export const GlassIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 17.25v3.375c0 .621-.504 1.125-1.125 1.125h-9.75c-.621 0-1.125-.504-1.125-1.125V17.25m12 0v-3.375c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v3.375m12 0h-12M15.75 6.75v-3.375c0-.621-.504-1.125-1.125-1.125H3.375c-.621 0-1.125.504-1.125 1.125v3.375m12 0h-12" />
  </svg>
);
...
export const ClipboardCheckIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75 11.25 15 15 9.75M9 12.75h4.5m-4.5 0a9 9 0 1 1 18 0 9 9 0 0 1-18 0Z" />
...
export const EnvelopeIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 9V18a2.25 2.25 0 0 1-2.25 2.25H4.5A2.25 2.25 0 0 1 2.25 18V9m19.5 0a2.25 2.25 0 0 0-2.25-2.25H4.5A2.25 2.25 0 0 0 2.25 9m19.5 0v.243a2.25 2.25 0 0 1-1.07 1.916l-7.5 4.615a2.25 2.25 0 0 1-2.36 0L3.32 11.16a2.25 2.25 0 0 1-1.07-1.916V9" />
