...
type ViewState = 
    ...
    | { view: 'system', tab?: 'staff' | 'profiles-sash' | 'profiles-casement' | 'profiles-door' | 'profiles-screen' | 'components' | 'materials' | 'settings' | 'email_smtp' | 'email_templates' | 'developer' | 'ranges' | 'invoicing' | 'project' }
